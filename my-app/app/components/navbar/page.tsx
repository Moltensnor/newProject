  ...
  if (user) {
    return (
      <div className="flex bg-void flex-row sticky w-screen gap-x-20 content-between opacity-100 min-h-[10vh]">
        {/*Logo*/}
        <div className="text-stark ml-8 mt-4 h-16 text-6xl col-span-2">
          Project
        </div>
        {/*Main redirects*/}
        <div className="flex justify-around text-stark ml-[35vh] mt-8 h-20 text-4xl right-0 w-4/12">
          <Link href={"../protected/tasklist"}>Tasklist</Link>
          <Link href={"../protected/tasklist"}>Cost Calculator</Link>
        </div>
        {/*Login*/}
        <div className="flex justify-self-end text-stark pt-6 h-20 text-4xl ml-[20vh] -right-0 w-2/12 gap-x-12">
