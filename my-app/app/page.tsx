            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
              ...
              <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
                ...
                <a href="#"
                  ...
                  <div className="py-2 px-9 relative  ">
                    <svg className="w-16 h-16 fill-gray-400 group-hover:fill-white"
                      xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 64 64" viewBox="0 0 64 64"
                      id="furniture">
                      <path
                ...
                <a href="#"
                  ...
                  <div className="py-2 px-9 relative  ">
                    <svg className="w-16 h-16 fill-gray-400 group-hover:fill-white"
                      xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 68 68" viewBox="0 0 68 68"
                      id="backpack">
                      <path
